...
from models.ni_predictor_models import MetricPredictorLSTM, MetricPredictorAttenPool, ExLSTM, \
    ...
    MetricPredictorAttenPool_layers
...
def main(args, config):
    ...
    if args.feats_model == "XLSREncoder":
        ...
        hidden_size = 257//2
        activation = nn.LeakyReLU
        att_pool_dim = 257 if args.model == "AttenPool" else 256
    ...
    elif args.model == "AttenPool_layers":
        model = MetricPredictorAttenPool_layers(att_pool_dim, num_layers = args.num_layers)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--summ_file", help="path to write summary results to" , default="save/CPC_feats_paper.csv"
    )
    parser.add_argument(
        "--out_csv_file", help="path to write the preditions to" , default=None
    )
    parser.add_argument(
        "--wandb_project", help="W and B project name" , default="CPC_feats"
    )
    parser.add_argument(
