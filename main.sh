#!/bin/bash
CUDA_VISIBLE_DEVICES=0 python MAIN_predict_intel_correctness_feats_cmvn.py default_config --feats WhisperFull --model LSTM --exp_id 001 --batch_size 2 --layer 11 --n_epochs 1 --skip_wandb
