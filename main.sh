...
CUDA_VISIBLE_DEVICES=0 python MAIN_IS3.py --feats Spec --exp_id test --run_id test --skip_wandb --n_epochs 1  --N 1 --model minerva_transform --ex_size 128 --fix_ex --feat_embed_dim 16 --class_embed_dim 1 --lr 2e-3 --weight_decay 1e-3 --p_factor 1 --batch_size 128
